 ...
 * the session is valid, the user is verified, and guarantees `ctx.session.user` is not null.
 *
 ...
 * Admin procedure
 *
 * This procedure is only accessible to users with the isAdmin flag set to true.
 */
